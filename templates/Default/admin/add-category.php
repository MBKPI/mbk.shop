          ...
          <div class="row">
            <div class="col-md-6">
              <div class="form-group">
                ...
                <input type="text" class="form-control" id="name" name="name" placeholder="Например: Мобильные телефоны">
              </div>
            </div>
            <div class="col-md-6">
              <div class="form-group">
                <label for="surname">Название категории (англ.)</label>
                <input type="text" class="form-control" id="surname" name="name_eng" placeholder="Например: telephones">
              </div>
            </div>
            <div class="col-md-12">
              <div class="form-group">
